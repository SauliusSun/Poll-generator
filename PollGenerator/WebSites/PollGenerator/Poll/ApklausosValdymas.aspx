...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApklausosValdymas.aspx.cs" Inherits="PollGenerator.Poll.Views.ApklausosValdymas"
    Title="Apklausos valdymas | Klausiu.lt" ResponseEncoding="windows-1257" ContentType="text/HTML" Culture="lt-LT" UICulture="lt-LT" MasterPageFile="~/Shared/DefaultMaster.master" %>
...
<asp:Content ID="content" ContentPlaceHolderID="DefaultContent" Runat="Server">
        ...
        <br />
        <br />
        Respondentas gali atsakyti á apklausà kelis kartus:
        <br />
        <br />
